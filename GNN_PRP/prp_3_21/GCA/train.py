...
import torch
# from https://pytorch-geometric.readthedocs.io/en/latest/modules/utils.html
# dropout_adj, add_self_loops, remove_self_loops, normalized_cut, negative_sampling, train_test_split_edges
